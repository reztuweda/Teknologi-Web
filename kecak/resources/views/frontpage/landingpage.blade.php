                        ...
                        <section>
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://d3p0bla3numw14.cloudfront.net/news-content/img/2020/09/03133519/kenali-dulu-ragam-tipe-kost-sebelum-sewa.jpeg"
                                        alt=""
                                ...
                                <form class="p-6">
                                    ...
                                    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b borderslate-200">
                                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae ipsam dicta, suscipit harum explicabo consequatur voluptas deserunt, esse magnam optio soluta! Laboriosam ea, aliquam, temporibus soluta quibusdam magni hic libero magnam beatae dolorum molestias vitae? Atque eum officia molestias magnam, omnis cum repudiandae incidunt doloremque. Harum repellendus doloremque molestias ullam?
                                    </div>
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            <a href="kalender">
                                                <button class="h-10 px-6 font-semibold rounded-full bg-violet600 text-white"
                                                type="submit">
                                                    Pesan Sekarang
                                            </button>
                                            </a>
                ...
                1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
                            ...
                            <div class="md:flex font-sans pt-8">
                                ...
                                <form class="p-6">
                                    ...
                                    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b borderslate-200">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto doloribus cum corporis qui reiciendis magni est accusamus, nisi harum ipsum rerum inventore laudantium veritatis non hic nam natus minima fuga quidem debitis! Ullam nihil officiis incidunt magni, placeat illum aspernatur repellendus et odio dolores nemo odit! Eaque omnis culpa deserunt!
                                    </div>
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            <button class="h-10 px-6 font-semibold rounded-full bg-violet600 text-white"
